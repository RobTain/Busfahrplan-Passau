    ...
    public LinkedList findBusLine(String s) {
        ...
        switch (s) {
            ...
            case "11_S_Z":
                ...
                break;
            case "K1_L_M":
                busStation = new BusStation("Anger");
                list.add(busStation);
                busStation = new BusStation("Augustinerstraße");
                list.add(busStation);
                busStation = new BusStation("Aumühlweg");
                list.add(busStation);
                busStation = new BusStation("Donauweg");
                list.add(busStation);
                busStation = new BusStation("Eggendobl");
                list.add(busStation);
                busStation = new BusStation("Fürstenweg");
                ...
                busStation = new BusStation("Kirchenplatz");
                list.add(busStation);
                busStation = new BusStation("Lüftlberg");
                list.add(busStation);
                busStation = new BusStation("Mariahilf-Grenzstation");
                list.add(busStation);
                busStation = new BusStation("Mozartstraße");
                list.add(busStation);
                busStation = new BusStation("Muffatstraße");
                list.add(busStation);
                busStation = new BusStation("Schulstraße");
                list.add(busStation);
                busStation = new BusStation("Stadttheater");
            ...
            case "K2_S_M":
                ...
                busStation = new BusStation("Kirchenplatz");
                list.add(busStation);
                busStation = new BusStation("Kühberg");
                list.add(busStation);
                busStation = new BusStation("Lindenthal 1");
                list.add(busStation);
                busStation = new BusStation("Linzer Straße");
                list.add(busStation);
                busStation = new BusStation("Mühltal");
                list.add(busStation);
                busStation = new BusStation("Mühltalstraße");
                list.add(busStation);
                busStation = new BusStation("Nagelschmiedgasse");
                ...
                busStation = new BusStation("Römerplatz");
                list.add(busStation);
                busStation = new BusStation("Sieglberg");
                list.add(busStation);
                busStation = new BusStation("Sieglgut");
                list.add(busStation);
                busStation = new BusStation("Stadttheater");
                list.add(busStation);
                busStation = new BusStation("Voglau");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 4");
                list.add(busStation);
                busStation = new BusStation("Schanzlbrücke");
                list.add(busStation);
                busStation = new BusStation("Klafterbrunnweg");
                list.add(busStation);
                break;
            case "K2_M_S":
                busStation = new BusStation("Augustinerstraße");
                ...
                busStation = new BusStation("Stadttheater");
                list.add(busStation);
                busStation = new BusStation("Zollamt Saming");
                list.add(busStation);
                busStation = new BusStation("Lindenthal 2");
                list.add(busStation);
                busStation = new BusStation("Schmiedgase");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 4");
                list.add(busStation);
                busStation = new BusStation("Am Schanzlturm");
            ...
            case "K3_K_H":
                ...
                busStation = new BusStation("Aufischer");
                list.add(busStation);
                busStation = new BusStation("Eduard-Hamm Straße");
                list.add(busStation);
                busStation = new BusStation("Giselastraße");
                list.add(busStation);
                busStation = new BusStation("Hochstraße");
                list.add(busStation);
                busStation = new BusStation("Ingling");
                list.add(busStation);
                busStation = new BusStation("Klinikum");
                list.add(busStation);
                busStation = new BusStation("Leopoldstraße");
                ...
                break;
            case "K3_H_K":
                busStation = new BusStation("Am Högl");
                list.add(busStation);
                busStation = new BusStation("Apfelkoch");
                list.add(busStation);
                busStation = new BusStation("Aufischer");
            ...
            case "K4_Z_S":
                ...
                list.add(busStation);
                busStation = new BusStation("Brand");
                list.add(busStation);
                busStation = new BusStation("Brand (Bedarfshaltestelle)");
                list.add(busStation);
                busStation = new BusStation("Brandweg");
                list.add(busStation);
                busStation = new BusStation("Danziger Straße");
                list.add(busStation);
                busStation = new BusStation("Dr. Geiger Weg");
                list.add(busStation);
                busStation = new BusStation("Gutenbergstraße");
                list.add(busStation);
                busStation = new BusStation("Hammerbachstraße");
                list.add(busStation);
                busStation = new BusStation("Hauptbahnhof");
                list.add(busStation);
                busStation = new BusStation("Herrmann-Woesner Straße");
                ...
                list.add(busStation);
                busStation = new BusStation("Medienstraße");
                list.add(busStation);
                busStation = new BusStation("Neustift");
                list.add(busStation);
                busStation = new BusStation("Neustift / Haus Waldesruh");
                list.add(busStation);
                busStation = new BusStation("Sagmeisterweg");
                list.add(busStation);
                busStation = new BusStation("Schreinerholzerweg");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 4");
                list.add(busStation);
                busStation = new BusStation("Bahnhofstraße");
            ...
            case "K4_S_Z":
                ...
                busStation = new BusStation("Neustift / Haus Waldesruh");
                list.add(busStation);
                busStation = new BusStation("Paula-Deppe Straße");
                list.add(busStation);
                busStation = new BusStation("Schreinerholzerweg");
                list.add(busStation);
                busStation = new BusStation("Sperrwies");
                list.add(busStation);
                busStation = new BusStation("Westendstraße");
                list.add(busStation);
                busStation = new BusStation("Bahnhofstraße");
            ...
            case "CB_B_R":
                ...
                busStation = new BusStation("Am Schanzl");
                list.add(busStation);
                busStation = new BusStation("Domplatz");
                list.add(busStation);
                busStation = new BusStation("Rathausplatz");
                list.add(busStation);
                busStation = new BusStation("Residenzplatz");
                list.add(busStation);
                busStation = new BusStation("Rindermarkt");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 5");
                list.add(busStation);
                busStation = new BusStation("Bahnhofstraße");
                list.add(busStation);
                busStation = new BusStation("Am Schanzlturm");
            ...
            case "CB_R_B":
                ...
                busStation = new BusStation("Römerplatz");
                list.add(busStation);
                busStation = new BusStation("Schlosserstiege");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 5");
                list.add(busStation);
                busStation = new BusStation("Bahnhofstraße");
