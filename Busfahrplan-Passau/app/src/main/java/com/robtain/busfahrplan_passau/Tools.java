    ...
    public LinkedList findBusLine(String s) {
        ...
        switch (s) {
            ...
            case "1":
                ...
                list.add(busStation);
                busStation = new BusStation("Am Schanzlturm","1", "20");
                list.add(busStation);
                busStation = new BusStation("Schönleitnerweg","1", "21");
                list.add(busStation);
                busStation = new BusStation("Schulzentrum / AOK","1", "22");
                list.add(busStation);
                busStation = new BusStation("St. Anton","1", "23");
                list.add(busStation);
                busStation = new BusStation("Waldschmidtstraße","1", "24");
                list.add(busStation);
            ...
            case "4":
                ...
                list.add(busStation);
                busStation = new BusStation("Römerplatz", "4", "19");
                list.add(busStation);
                busStation = new BusStation("Rosensteig", "4", "20");
                list.add(busStation);
                busStation = new BusStation("Schanzlturm", "4", "21");
                list.add(busStation);
                busStation = new BusStation("Schmiedgasse", "4", "22");
                list.add(busStation);
                busStation = new BusStation("Schwendistraße", "4", "23");
                list.add(busStation);
                busStation = new BusStation("Stadttheater", "4", "24");
                list.add(busStation);
