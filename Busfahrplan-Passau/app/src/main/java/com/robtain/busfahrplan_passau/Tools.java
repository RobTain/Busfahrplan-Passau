    ...
    public LinkedList findBusLine(String s) {
        ...
        switch (s) {
            ...
            case "K2_S_M":
                ...
                list.add(busStation);
                busStation = new BusStation("Ilzbrücke", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Jahnstraße", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Kirchenplatz", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Klafterbrunnweg", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Kühberg", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Lindenthal 1", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Linzer Straße", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Mühltal", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Mühltalstraße", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Nagelschmiedgasse", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Rathaus", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Römerplatz", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Schanzlbrücke", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Sieglberg", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Sieglgut", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Stadttheater", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("Voglau", "K2_S_M", "1");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 4", "K2_S_M", "1");
                list.add(busStation);
                break;
            case "K2_M_S":
                ...
                list.add(busStation);
                busStation = new BusStation("Mühltal", "K2_M_S", "5");
                list.add(busStation);
                busStation = new BusStation("Mühltalstraße", "K2_M_S", "6");
                list.add(busStation);
                busStation = new BusStation("Nagelschmiedgasse", "K2_M_S", "7");
                list.add(busStation);
                busStation = new BusStation("Rathaus", "K2_M_S", "8");
                list.add(busStation);
                busStation = new BusStation("Römerplatz", "K2_M_S", "9");
                list.add(busStation);
                busStation = new BusStation("Stadttheater", "K2_M_S", "10");
                list.add(busStation);
                busStation = new BusStation("Zollamt Saming", "K2_M_S", "11");
                list.add(busStation);
                busStation = new BusStation("Lindenthal 2", "K2_M_S", "12");
                list.add(busStation);
                busStation = new BusStation("Schmiedgase", "K2_M_S", "13");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 4", "K2_M_S", "14");
                list.add(busStation);
                busStation = new BusStation("Am Schanzlturm", "K2_M_S", "15");
                list.add(busStation);
                break;
            case "K3_K_H":
