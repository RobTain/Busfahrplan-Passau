    ...
    public LinkedList findBusLine(String s) {
        ...
        switch (s) {
            ...
            case "7_E_R":
                ...
                list.add(busStation);
                busStation = new BusStation("Bockhofweg");
                list.add(busStation);
                busStation = new BusStation("Danziger Straße");
                list.add(busStation);
                busStation = new BusStation("Dr. Geiger-Weg");
                ...
                busStation = new BusStation("Kraftstraße");
                list.add(busStation);
                busStation = new BusStation("Kreuzbergstraße");
                list.add(busStation);
                busStation = new BusStation("Lambergstraße");
                list.add(busStation);
                ...
                busStation = new BusStation("Leopoldstraße");
                list.add(busStation);
                busStation = new BusStation("Martin-Seitz Straße");
                list.add(busStation);
                busStation = new BusStation("Max-Matheis Straße");
                list.add(busStation);
                busStation = new BusStation("Neustift");
                list.add(busStation);
                busStation = new BusStation("Plantage");
                list.add(busStation);
                ...
                busStation = new BusStation("Sailerwöhr");
                list.add(busStation);
                busStation = new BusStation("Schreinerbauerweg");
                list.add(busStation);
                busStation = new BusStation("Schulstraße");
                list.add(busStation);
                busStation = new BusStation("Senefelderstraße");
                list.add(busStation);
                busStation = new BusStation("Westendstraße");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 3");
                list.add(busStation);
                busStation = new BusStation("Anzengruberstraße");
                list.add(busStation);
                busStation = new BusStation("Am Schanzl");
                list.add(busStation);
                busStation = new BusStation("Sturmbergweg");
                list.add(busStation);
                busStation = new BusStation("Westerburgerstraße");
                list.add(busStation);
                break;
            case "7_R_E":
                ...
                busStation = new BusStation("Reinhard-Raffalt Straße");
                list.add(busStation);
                busStation = new BusStation("Ries");
                list.add(busStation);
                busStation = new BusStation("Sailerwöhr");
                list.add(busStation);
                busStation = new BusStation("Schreinerbauerweg");
                ...
                break;
            case "8_9_Kohl_Koenig":
                busStation = new BusStation("Apfelkoch");
                list.add(busStation);
                busStation = new BusStation("Augustinergasse");
                list.add(busStation);
                ...
                list.add(busStation);
                busStation = new BusStation("Hacklstein");
                list.add(busStation);
                busStation = new BusStation("Hauptbahnhof");
                list.add(busStation);
                busStation = new BusStation("Heining");
                list.add(busStation);
                busStation = new BusStation("Kachlet");
                list.add(busStation);
                busStation = new BusStation("Klinikum");
                list.add(busStation);
                busStation = new BusStation("Kohlbruck / Erlebnisbad PEB");
                list.add(busStation);
                ...
                list.add(busStation);
                busStation = new BusStation("Rittsteig");
                list.add(busStation);
                busStation = new BusStation("Schönleitnerweg");
                list.add(busStation);
                ...
                list.add(busStation);
                busStation = new BusStation("Universität");
                list.add(busStation);
                busStation = new BusStation("Vornholz");
                list.add(busStation);
                busStation = new BusStation("Weinleitenweg");
                list.add(busStation);
                busStation = new BusStation("Winzerleite");
                list.add(busStation);
                busStation = new BusStation("Wörthstraße");
                list.add(busStation);
                busStation = new BusStation("ZOB Bussteig 3");
                list.add(busStation);
            ...
            case "8_9_Koenig_Kohl":
                ...
                busStation = new BusStation("Breslauerstraße");
                list.add(busStation);
                busStation = new BusStation("Eich");
                list.add(busStation);
                busStation = new BusStation("Gionstraße");
                list.add(busStation);
                busStation = new BusStation("Graf-Salm Straße");
                ...
                busStation = new BusStation("Söldenpeterweg");
                list.add(busStation);
                busStation = new BusStation("Stallerweg");
                list.add(busStation);
                busStation = new BusStation("Steinbachmühle");
                list.add(busStation);
                busStation = new BusStation("Stelzhamer Straße");
            ...
            case "10_Z_S":
                ...
                list.add(busStation);
                busStation = new BusStation("Gartenstraße");
                list.add(busStation);
                busStation = new BusStation("Hauptbahnhof");
                list.add(busStation);
                ...
                busStation = new BusStation("Neustift");
                list.add(busStation);
                busStation = new BusStation("Prügelweg");
                list.add(busStation);
                busStation = new BusStation("Raiffeisenstraße");
                list.add(busStation);
                busStation = new BusStation("Reuthinger Weg");
                list.add(busStation);
                busStation = new BusStation("Schalding r.d.D.");
                list.add(busStation);
                busStation = new BusStation("Steinbachmühle");
                list.add(busStation);
                busStation = new BusStation("Stelzhamer Straße");
                ...
                list.add(busStation);
                busStation = new BusStation("Bahnhofsstraße");
                list.add(busStation);
                break;
            case "10_S_Z":
                busStation = new BusStation("Buchenstraße");
                list.add(busStation);
                busStation = new BusStation("Einöder Straße");
                list.add(busStation);
                busStation = new BusStation("Gartenstraße");
                list.add(busStation);
                ...
                busStation = new BusStation("Hochlandweg");
                list.add(busStation);
                busStation = new BusStation("Hoffeldweg");
                list.add(busStation);
                busStation = new BusStation("Holzmannstraße");
                list.add(busStation);
                busStation = new BusStation("Neustift");
            ...
            case "11_Z_S":
                busStation = new BusStation("B. von Behr Straße");
                list.add(busStation);
                busStation = new BusStation("Carossastraße");
                list.add(busStation);
                busStation = new BusStation("Eichendorffstraße");
                list.add(busStation);
                busStation = new BusStation("Eichetstraße");
                ...
                busStation = new BusStation("Reinhard-Raffalt Straße");
                list.add(busStation);
                busStation = new BusStation("Rittsteigerstraße");
                list.add(busStation);
                busStation = new BusStation("Stallerweg");
                list.add(busStation);
                busStation = new BusStation("Steinbachmühle");
