...
public class ContactActivity extends AppCompatActivity {
    ...
    //ToDO hier noch eine richtige Emailadresse einfügen!!!
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem item) {
                        ...
                        if (id == R.id.mathematicsNavMenu) {
                            i = new Intent(ContactActivity.this, SubmenuMathActivity.class);
                            openView(i);

                            // Handle the camera action
                        } else if (id == R.id.physicsNavMenu) {
                            i = new Intent(ContactActivity.this, SubmenuPhysicActivity.class);
                            openView(i);
                        } else if (id == R.id.computerscienceNavMenu) {
                            i = new Intent(ContactActivity.this, SubmenuInformaticActivity.class);
                            openView(i);
                        } else if (id == R.id.chemistryNavMenu) {
                            i = new Intent(ContactActivity.this, SubmenuChemistryActivity.class);
                            openView(i);
                        } else if (id == R.id.biologyNavMenu) {
                            i = new Intent(ContactActivity.this, SubmenuBiologyActivity.class);
                            openView(i);
                        } else if (id == R.id.accountingNavMenu) {
                            i = new Intent(ContactActivity.this, SubmenuAccountingActivity.class);
                            openView(i);
                            ...
                            i = new Intent(ContactActivity.this, LexiconActivity.class);
                            openView(i);
                        } else if (id == R.id.contactNavMenu) {
                            i = new Intent(ContactActivity.this, ContactActivity.class);
                            openView(i);

                        } else if (id == R.id.rateNavMenu) {
                            i = new Intent(ContactActivity.this, RateAppActivity.class);
                            openView(i);
                        } else if (id == R.id.buyPremiumNavMenu) {
                            i = new Intent(ContactActivity.this, BuyPremiumActivity
                                    .class);
                            openView(i);
                        }
                        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
