...
public class LexiconActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sublist = lexicon.getLexicon();
        Collections.sort(sublist, new Comparator() {
            @Override
            public int compare(Object lhs, Object rhs) {
                return ((LexiconEntry) lhs).getTitle().compareTo(((LexiconEntry)
                        rhs).toString());
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                finish();
                Intent menu = new Intent(LexiconActivity.this, ShowEntryActivity.class);
                overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
                startActivity(menu);
            }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            finish();
            Intent menu = new Intent(LexiconActivity.this, StartActivity.class);
            overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
            startActivity(menu);
        }
    }
